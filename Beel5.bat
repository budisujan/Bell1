...
Write-Host "=======================================" -ForegroundColor Cyan;
Write-Host "ALAMAT MURID: http://$($ip):3000" -ForegroundColor Green;
Write-Host "LOGIN GURU  : admin#123" -ForegroundColor White;
Write-Host "=======================================" -ForegroundColor Cyan;
    ...
    while ($listener.IsListening) {
        ...
        if ($path -eq "/update") {
            ...
            if ($global:status -eq "false" -or $newLock -eq "false" -or $newUser -eq "RESET OLEH GURU") {
                ...
                $global:user = $newUser;
                Write-Host "Update: $global:user" -ForegroundColor Green;
            }
